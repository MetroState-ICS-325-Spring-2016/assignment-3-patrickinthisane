...
// tables together.
$query_result = $mysql_connection->query("SELECT customerName, country, employees.firstName, employees.lastName FROM customers INNER JOIN employees ON employees.employeeNumber = customers.salesRepEmployeeNumber ORDER BY country, customerName");
